...
export function setupAuth() {
  ...
  function setupRegisterForm() {
    ...
    registerForm.addEventListener("submit", async function (e) {
      ...
      const address = {
        fullName:
          document.getElementById("register-address-fullname").value ||
          fullName,
        ...
        addressLine2:
          document.getElementById("register-address-line2").value || "",
      ...
      const subscribeNewsletter = document.getElementById(
        "register-newsletter"
      ).checked;
...
function setupRegisterForm() {
  ...
  registerForm.addEventListener("submit", async function (e) {
    ...
    const address = {
      fullName:
        document.getElementById("register-address-fullname").value || fullName,
      phoneNumber: document.getElementById("register-phone").value,
      addressLine1: document.getElementById("register-address-line1").value,
      addressLine2:
        document.getElementById("register-address-line2").value || "",
